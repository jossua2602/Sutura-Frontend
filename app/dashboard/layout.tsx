    ...
    <div className={`min-h-screen bg-[#F6F1ED] flex ${inter.className}`}>
      ...
      <aside className="w-64 bg-[#FFFFFF] border-r border-[#D8CDC5] flex flex-col shadow-sm">
        ...
        <div className="h-20 flex items-center justify-center border-b border-[#D8CDC5]">
          <h1 className={`${playfair.className} text-3xl text-[#4A3F3A] tracking-tight`}>
            sutura
          </h1>
        </div>
      ...
      <main className="flex-1 flex flex-col">
        ...
        <header className="h-20 bg-[#FFFFFF] border-b border-[#D8CDC5] flex items-center justify-between px-10 shadow-sm">
          ...
          <div className="flex items-center gap-4 cursor-pointer group">
            <span className="text-sm font-medium text-[#8A7F78] group-hover:text-[#4A3F3A] transition-colors">
              Admin Jossua
            </span>
            <div className="w-10 h-10 bg-[#A88A7B] text-white rounded-full flex items-center justify-center font-semibold group-hover:bg-[#8E7265] transition-colors">
              J
            </div>
          </div>
        </header>
